...
test_that("Barometric pressure match table values in ASHRAE handbook", {
...
test_that("Check 100 % relative humidity limit", {
  hum.ratio <- 0.010
  temp.air <- 10
  alt <- 0
...
test_that("Check if relative humidity fits ASHRAE Handbook psychrometric chart", {
...
test_that("Check if humidity ratio fits ASHRAE Handbook psychrometric chart", {
