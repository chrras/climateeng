ppd <- function(clo, temp.air, temp.rad, rel.hum, met = 1.2, wme = 0, air.velo = 0.1, partial.press = 0) {
  ...
  #' @param partial.press Vector of water vapour pressures in [Pa]. Defaults to 0 Pa.
